...
# Redlat <img src="figures/readme/compendium-sticker.png" align="right" style="float:right; height:120px;"/>
...
-   [`DESCRIPTION`](https://github.com/NataliaSantisA/Redlat/tree/main/DESCRIPTION):
    contains project metadata (authors, date, dependencies, etc.)

-   [`make.R`](https://github.com/NataliaSantisA/Redlat/tree/main/make.R):
    main R script to run the entire project

-   [`R/`](https://github.com/NataliaSantisA/Redlat/tree/main/R):
...
Guidelines](https://github.com/NataliaSantisA/Redlat/blob/main/CONTRIBUTING.md).
