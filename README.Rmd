...
Launch the [`make.R`](https://github.com/NataliaSantisA/Redlat/tree/main/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/NataliaSantisA/Redlat/blob/main/CONTRIBUTING.md).
